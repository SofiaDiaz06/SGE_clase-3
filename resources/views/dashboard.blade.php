        ...
        <div class="col-xl-4 col-md-6 mb-4">             
            <div class="card card-stats shadow h-100" style="border-left-color: #1cc88a;">                 
                <div class="card-body">                     
                    <div class="row align-items-center">                         
                        <div class="col">                             
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">                                 Nuevos Hoy</div>                             
        ...
        <div class="col-xl-4 col-md-6 mb-4">             
            <div class="card card-stats shadow h-100" style="border-left-color: #f6c23e;">                 
                <div class="card-body">                     
                    <div class="row align-items-center">                         
                        <div class="col">                             
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">                                 Registros Totales</div>                             
